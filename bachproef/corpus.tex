...
\newline
%DIT NALEZEN
De eerste case die geprint werd, was vrij eenvoudig. Het was uitgetekend als een potdeksel-systeem. Omdat de nauwkeurigheid van de 3D-printer niet hoog genoeg was, kon het deksel nooit alles volledig afsluiten. Hierdoor was er een nood aan een volledig nieuw model (zie figuur: \ref{fig:first_case}). Het tweede model was een schroefsysteem. Ook waren er paar eisen aan wat het model moest voldoen. Om de reikwijdte optimaal te houden, zou de antenne van de proof of concept zich eerst buiten de case moeten bevinden. Hierdoor zou het signaal ongestoord kunnen werken. De allereerste test die uitgevoerd werd was de waterbestendigheid. Helaas voldeed de case niet, maar dit was te wijten door de snee in het onderste deel van de case. Deze snee zou opgevuld worden met de kabel van de antenne. De eerste test werd herhaald, maar deze keer met de antenne op de juiste plaats. Het resultaat van deze test was terug een teleurstelling. Eens de case volledig in elkaar geschroefd was, kon deze niet opnieuw geopend worden. Wellicht is dit opnieuw te wijten aan de onnauwkeurigheid van de gebruikte 3D-printer. Na twee pogingen en 36 uur printen, werd er gezocht naar een andere mogelijkheid. De huidige behuizing is IP66 gecertificeerd. Dit garandeert dat het volledig waterdicht en stofvrij is.
