...
Als we spreken over het bepalen van een locatie, gebruiken we systematisch de term 'GPS'. Dit is echter niet correct, want er bestaan veel meer technologieën en systemen die hierbij helpen. Deze technologieën worden besproken in dit hoofdstuk.
\newline
...
\end{itemize} 
Andere voordelen zijn de hogere accuraatheid (5-50 meter) en er zijn slechts twee waarneembare GPS-satellieten nodig.
...
\newline
Deze methode wordt gebruikt bij noodtelfoon oproepen. Bij het begin van het bellen wordt er eerst gekeken of de wifi en GPS aanstaat. Als de 'battery check' positief is, worden deze services automatisch geactiveerd. 
\newline
